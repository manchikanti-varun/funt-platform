...
export default function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-8">
      <Link href="/dashboard" className="text-sm font-semibold text-black underline decoration-funt-gold decoration-2">
        ← Back
      </Link>
      <h1 className="mt-4 text-3xl font-black tracking-tight text-black">My account</h1>
      <p className="mt-2 text-sm text-black/60">
        Sign in with your <strong className="text-black">username</strong> (e.g. <span className="font-mono">srikar.ch</span>). Only a super admin can change usernames. Admins use an{" "}
        <span className="font-mono">@funt</span> style login.
      </p>
      ...
      <form onSubmit={handleSave} className="mt-8 space-y-5">
        ...
        {msg && <p className="text-sm font-medium text-black">{msg}</p>}
