...
router.get("/", requireRoles(ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.SUB_ADMIN, ROLE.TRAINER), listBatches);
router.post("/bulk-delete", requireRoles(ROLE.SUPER_ADMIN), bulkDeleteBatches);
router.get("/:id/students", requireRoles(ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.SUB_ADMIN, ROLE.TRAINER), getBatchStudents);
router.post("/:id/students", requireRoles(ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.SUB_ADMIN), addBatchStudent);
router.post("/:id/students/bulk", requireRoles(ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.SUB_ADMIN), bulkAddBatchStudents);
router.post("/:id/students/bulk-remove", requireRoles(ROLE.SUPER_ADMIN, ROLE.ADMIN, ROLE.SUB_ADMIN), bulkRemoveBatchStudents);
