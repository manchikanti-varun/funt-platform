...
const ALL_ROLES = [ROLE.STUDENT, ROLE.PARENT, ROLE.TRAINER, ROLE.ADMIN, ROLE.SUB_ADMIN, ROLE.SUPER_ADMIN, ROLE.SUPPORT_AGENT, ROLE.FRANCHISE_ADMIN] as const;
const STAFF_ROLES = [ROLE.TRAINER, ROLE.ADMIN, ROLE.SUB_ADMIN, ROLE.SUPER_ADMIN, ROLE.SUPPORT_AGENT] as const;
