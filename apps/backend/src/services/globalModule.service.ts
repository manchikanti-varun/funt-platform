...
export async function createModule(input: CreateModuleInput) {
  ...
  return {
    ...
    linkedQuizId: (doc as { linkedQuizId?: string }).linkedQuizId,
    version: doc.version,
    status: doc.status,
...
export async function listModules(filters?: { status?: string; search?: string; courseId?: string }) {
  ...
  return list.map((d) => ({
    ...
    linkedQuizId: (d as { linkedQuizId?: string }).linkedQuizId,
    version: d.version,
    status: d.status,
...
export async function updateModule(
  ...
  return {
    ...
    linkedQuizId: (existing as { linkedQuizId?: string }).linkedQuizId,
    version: existing.version,
...
export async function duplicateModule(id: string, performedBy: string) {
  ...
  const doc = await GlobalModuleModel.create({
    ...
    linkedQuizId: (src as { linkedQuizId?: string }).linkedQuizId ?? undefined,
    version: 1,
    status: MODULE_STATUS.ACTIVE,
