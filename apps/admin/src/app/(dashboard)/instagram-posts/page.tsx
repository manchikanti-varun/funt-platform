        ...
        {loading ? (
          ...
          <div className="grid gap-3">
            {posts.map((post) => (
              ...
              >
                {/* Thumbnail preview */}
                <div className="shrink-0 w-16 h-16 rounded-lg overflow-hidden bg-black/5 border border-black/10">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src={`https://www.instagram.com/p/${getShortcode(post.postUrl)}/media/?size=t`}
                    alt=""
