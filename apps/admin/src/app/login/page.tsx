  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-slate-50 via-white to-teal-50/40 p-4">
      <div
        ...
        style={{
          background:
            "radial-gradient(520px 280px at 50% -8%, rgba(99,102,241,0.20), transparent 70%)",
        }}
      />
      <FormPanel className="relative w-full max-w-[410px] rounded-3xl bg-white/95 px-7 py-6 shadow-soft sm:px-8 sm:py-7">
        <header className="mb-6 text-center">
          <div className="mx-auto flex flex-col items-center gap-2.5">
            ...
            />
            <div>
              <p className="label-overline text-black/70">FUNT Admin</p>
              <h1 className="mt-1 font-brand-learn text-2xl font-black tracking-tight text-slate-800 sm:text-[1.65rem]">
                Sign in
              </h1>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="input font-mono text-black placeholder:text-black/45"
          ...
          <div className="relative py-2">
            <span className="absolute inset-0 flex items-center"><span className="w-full border-t border-black/[0.08]" /></span>
            <span className="relative flex justify-center bg-gradient-to-b from-white to-[#fffdf6] px-3 text-[11px] font-semibold uppercase tracking-[0.14em] text-black/40">
              or continue with
            </span>
          </div>
          <a
